...
- ⚡ **Peeling Chain Topology**: Trace multi-hop laundering pathways step-by-step.`,
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="p-4 border-b border-slate-800 flex items-center justify-between bg-gradient-to-r from-slate-900 via-slate-900 to-slate-950">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-950/40">
        {messages.map((m) => {
          ...
          return (
            ...
            >
              <div
                className={`max-w-[92%] rounded-xl p-3.5 text-xs shadow-md ${
                  m.sender === "user"
                    ? "bg-gradient-to-r from-amber-500 to-amber-600 text-slate-950 font-semibold"
                    : m.isScamDetection
                    ? "bg-slate-900 border-2 border-amber-500/40 text-slate-200 shadow-amber-500/5"
                          ...
                          <div className="w-full bg-slate-900 rounded-full h-2 overflow-hidden border border-slate-800">
                            <div
                              className={`h-full rounded-full transition-all duration-700 ${
                                isHighCertainty
                                  ? "bg-gradient-to-r from-amber-500 via-emerald-400 to-emerald-500"
      ...
      <div className="p-3.5 border-t border-slate-800 bg-slate-950 flex items-center gap-2.5">
        ...
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 disabled:opacity-40 text-slate-950 font-bold text-sm flex items-center gap-2 transition-all shadow-md shrink-0 cursor-pointer"
        >
          <Send size={15} /> Send
        </button>
      </div>
